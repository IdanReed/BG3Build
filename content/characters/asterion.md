...
- name: The Fist in the Dark
  ...
  itemization:
    ...
    - id: resonance-stone
      ...
      slot: other
      note: 'Mind Flayer Colony, late Act 2. He carries it — Manifestation of Mind and Psionic Overload across 4–6 hits per turn all double. ⚠ The aura also makes the party (and him — no Gnome Cunning) psychic-vulnerable and disadvantaged on mental saves; keep it inside Charles''s Aura of Protection, or skip it vs psychic/mind enemies.'
    - id: eversight-ring
  ...
  pickpocket:
    note: |-
      Still the party thief, but WITHOUT Rogue 11 Reliable Talent — steals are no longer floor-guaranteed. Expertise + Graceful Cloth advantage still clear nearly every Act 1–2 lift; save-scum the rare high-DC item.
