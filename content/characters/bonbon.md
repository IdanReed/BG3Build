...
- name: The Commander
  ...
  playstyle: |-
    - **Act 1 default:** Titanstring + Hill Giant club main hand + Knife off-hand, Bloodlust, Protecty Sparkswall for control DC. Ranged Slashing Flourish for nova damage; trigger Broodmother's Revenge with healing before a multi-projectile turn.
    - **Act 1 alternatives:** Hill Giant elixir for a boss with no Bloodlust target; Adamantine Splint for defence.
    - **Act 2+:** dual hand crossbows + Flourish to stack Arcane Acuity. In Act 3, spend it on a same-turn bonus-action Hold Monster or Command.
    - **Protect concentration:** stay at range. Vs undead, use Hypnotic Pattern or Slow instead of Hold Monster/Command.
---
