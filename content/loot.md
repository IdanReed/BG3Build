...
- act: 1
  ...
  - area: Ravaged Beach / Dank Crypt & Camp
    ...
    - name: Silver Pendant
      ...
      core: true
      note: 'Harper outpost skeleton, SW of the Grove (X 152, Y 366). Guidance at will — the permanent replacement once Gale drops Tempest Cleric at char 6. ⚠ Never feed it to Gale''s orb.'
  ...
  - area: Emerald Grove
    ...
    - name: Safeguard Shield
      for: Gale
      core: true
      note: Dammon. +2 AC, +1 all saves — guards Twinned Haste. Civil Militia keeps shield proficiency after the respec.
  ...
  - area: Blighted Village & Whispering Depths
    ...
    - name: Haste Helm
      for: Charles
      core: true
      note: Moss-Covered Chest. Charles keeps the opening Momentum — his Ring leaves the head slot free. Asterion may borrow it; Gale has Tempestuous Magic.
  ...
  - area: Underdark
    ...
    - name: Melf's First Staff
      for: Gale
      core: true
      note: Blurg. +1 Spell Save DC and spell attacks — swap off Spellsparkler when a save-based cast matters more than charges.
  ...
  - area: Grymforge
    ...
    - name: The Protecty Sparkswall
      for: Bonbon
      core: true
      note: Trapped bridge chest. +1 Spell Save DC for Hold Person, Hypnotic Pattern, Fear, Slow and Glyph — Bonbon's late-Act-1 chest. Adamantine Splint stays the defensive alternative.
    ...
    - name: Armour of Uninhibited Kushigo
      for: Asterion
      core: false
      note: Sergeant Thrinn, for returning her boots. Patient Defence gains a reaction unarmed counterattack on a miss. Graceful Cloth stays selected.
  ...
  - area: Mountain Pass / Rosymorn Monastery / Crèche Y'llek
    ...
    - name: Gloves of Belligerent Skies
      for: Gale
      core: true
      note: Inquisitor's Chamber. Thunder/Lightning/Radiant → Reverberation, save-based Lightning Bolt included. ⚠ Triggers once per attack, so an AoE hits only its first logged target.
...
- act: 2
  ...
  - area: Shadow-Cursed Lands
    ...
    - name: Shadow of Menzoberranzan
      for: any
      core: false
      note: Head slot, from Kar'niss. Invisibility 1/short rest while in shadow or darkness — excellent for any scout.
    events:
  ...
  - area: Last Light Inn
    ...
    - name: Coruscation Ring
      for: Gale
      core: true
      note: Trapped chest, hidden cellar room. Spell damage while illuminated → Radiating Orb.
    - name: Covert Cowl
      wiki: Covert Cowl
      for: Charles
      core: false
      note: Cellar Meenlock. −1 crit threshold while Obscured — Charles's Act-2 Darkness head once Bonbon frees the Diadem for the Helmet of Arcane Acuity.
    - name: Potent Robe
      for: Gale
      core: true
      note: Alfira at Last Light — ONLY if she survived Act 1 (as the Dark Urge, Charles must knock her out before camp, not kill her). +CHA to cantrip damage.
    events:
  ...
  - area: Moonrise Towers
    ...
    - name: Spineshudder Amulet
      for: any
      core: false
      note: Mimic in Isobel's bedroom (upper floor). Reverberation on ranged SPELL-ATTACK hits only — weak for Gale's save-based nukes.
  ...
  - area: Gauntlet of Shar
    ...
    - name: Callous Glow Ring
      for: Gale
      core: true
      note: Vault behind the DC30 door near Balthazar. +2 Radiant vs illuminated creatures.
    - name: Hellfire Hand Crossbow
      for: Bonbon
      core: true
      note: Yurgir. Pairs with Ne'er Misser for Bonbon's Act 2 Acuity engine.
...
- act: 3
  ...
  - area: Rivington
    ...
    - name: Hellrider's Longbow
      ...
      for: Bonbon
      core: true
      note: Ferg Drogher. +initiative — the controller wants to go first.
    - name: Nyrulna
      for: any
      core: false
    ...
    - name: Spellmight Gloves
      ...
      core: false
      note: Lucretious, for Find Dribbles the Clown. Extra damage on attack-roll spells at −5 attack; Gale's lightning is save-based, so he keeps Belligerent Skies.
  ...
  - area: Sorcerous Sundries / Ramazith's Tower
    ...
    - name: Markoheshkir
      for: Gale
      core: true
      note: Ramazith's Tower, via Sorcerous Sundries. Kereska's Favour → a free empowered elemental spell; pick Lightning. Gale's endgame staff.
  ...
  - area: Stormshore Tabernacle
    ...
    - name: Amulet of the Devout
      for: Gale
      core: true
      note: Main offering chest, basement. +2 spell save DC + an extra Channel Divinity. ⚠️ Looting it inflicts Castigated By Divinity unless Jaheira loots it wearing Khalid's Gift.
    events:
    - name: The curse trap
  ...
  - area: House of Hope (Raphael)
    ...
    - name: Helldusk Armour
      for: Charles
      core: false
      note: Self-proficient defensive alternative when raw AC and resistances beat Luminous Armour's Shockwaves.
    ...
    - name: Helldusk Boots
      for: any
      core: false
      note: Fire immunity, a bonus-action reposition and anti-prone protection. Flex boots — Charles does not need the full set.
  ...
  - area: Cazador's Palace
    ...
    - name: Rhapsody
      ...
      core: false
      note: Cazador. Scarlet Remittance builds after kills, but Asterion cannot use a dagger without losing Tavern Brawler and the unarmed riders.
  ...
  - area: Steel Watch Foundry
    ...
    - name: Gontr Mael
      for: Bonbon
      core: true
      note: Steel Watcher Titan, Control Centre. Legendary longbow with Celestial Haste and Guiding Bolt, but NO initiative — compare with Hellrider's when Bonbon must act first.
    events:
  ...
  - area: Lower City (Zhentarim / vendors)
    ...
    - name: Birthright
      for: Gale
      core: true
      note: 'Sorcerous Sundries, ground floor. +2 CHA helm (cap 22; stacks with the Mirror''s Bard''s Memory toward 24) — free CHA for Gale''s head slot.'
