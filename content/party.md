...
item_allocation:
- item: Act 1 — Charles
  to: Two-handed bound Phalar Aluve; Staff of Arcane Blessing (buff swap); Darkness Arrows; Dual Hand Crossbows +1; Luminous Armour; Boots of Striding; Amulet of Misty Step; Haste Helm; Gloves of Baneful Striking; Ring of Arcane Synergy; Strange Conduit Ring; no cloak available; temporary Great Weapon Master
  why: 'Hexblade binds the Versatile Phalar while two-handed, so char 6 takes GWM over Dual Wielder. Pre-cast Shriek, then use free Darkness Arrow clouds for Devil''s Sight advantage while concentrating on Bless, Divine Favour or Hex. Booming Blade triggers Arcane Synergy; Smite at char 4, Extra Attack at 7. ⚠ He keeps the Haste Helm rather than lending it out — worst initiative in the party and the longest distance to close. ⚠ His cloak slot stays EMPTY through Act 1: the Deathstalker Mantle is the only magical cloak in the act and it goes to Asterion.'
- item: Act 2 — Charles (after Resonance Stone)
  to: 3d8 Shadow Blade main hand + Phalar Aluve off-hand; Resonance Stone aura; Dual Wielder; Risky Ring + Killer's Sweetheart; Adamantine Scale Mail; Covert Cowl; Cloak of Protection; Boots of Striding; Amulet of Misty Step; Gloves of Baneful Striking
  why: 'Respec at char 9 to Warlock 5 / Paladin 4 — Dual Wielder replaces GWM, Savage Attacker second, Shadow Blade lands at 3d8 as the bound main hand, Phalar stays off-hand so Shriek runs. Charles self-casts Darkness from here; Asterion keeps the Stone within 9m. The Adamantine Scale Mail (second Mithral ore) gives crit immunity, and the Cloak of Protection is the only Act 2 cloak that offsets the Risky Ring''s save penalty. The Shadow Blade Ring costs no slot — summon, then unequip it.'
- item: Act 3 — Charles
  to: 3d8 Shadow Blade + Phalar Aluve; Helldusk Armour; Sarevok's Horned Helmet; Helldusk Gloves; Helldusk Boots; Cloak of Protection; Amulet of Greater Health; Risky Ring + Killer's Sweetheart
  why: 'Helldusk Armour is legal on him — it grants its own proficiency, so a medium-armour Paladin/Warlock can wear AC 21 with −3 damage from every source. The Act 3 package exists to make the Risky Ring safe: Amulet of Greater Health''s advantage on Constitution saves cancels the ring''s disadvantage outright, and Helldusk Boots turn one failed save a turn into a success. Helm of Balduran is the swap when crit immunity matters more than Sarevok''s extra crits.'
- item: Act 1 — Asterion
  to: Empty melee hands; Dual Hand Crossbows +1; Graceful Cloth; Circlet of Psionic Revenge; Bracers of Defence; Disintegrating Night Walkers; Sentient Amulet; Bracing Band; Crusher's Ring; Deathstalker Mantle
  why: 'From char 5 the melee hands stay empty so Attack/Extra Attack are unarmed and Tavern Brawler applies; Corellon''s Grace is a levels 2–4 weapon only. ⚠ HIS HEAD IS CONSTRAINED: helmets tagged as Light/Medium/Heavy armour switch off Unarmoured Defence AND Bracers of Defence, which rules out Covert Cowl and the Dark Justiciar Helmet permanently — the Circlet of Psionic Revenge is the legal pick. The Bracing Band gives +1 AC on any turn he uses Flurry of Blows: Push, which is why the Ring of Protection can go to Gale. Swap Bracers for Sparkle Hands or Cinder and Sizzle for damage; keep Gloves of Thievery and Smuggler''s Ring as theft swaps.'
- item: Acts 2–3 — Asterion
  to: 'Act 2: Amulet of the Harpers; Flawed Helldusk Gloves; Shadow-Cloaked Ring + Eversight Ring; carries the Resonance Stone. Act 3: Vest of Soul Rejuvenation; Mask of Soul Perception; Gloves of Soul Catching; Boots of Uninhibited Kushigo; Cloak of Displacement; Ring of Free Action'
  why: 'The Amulet of the Harpers is timed to the Resonance Stone — its advantage on Wisdom saves cancels the disadvantage the Stone inflicts on its own carrier. The Eversight Ring is what lets him fight inside Charles''s Darkness at all, since blind immunity also sees through magical darkness. Act 3 completes the Soul set (Vest + Gloves + Mask) for +2 AC and a reaction unarmed strike on every miss.'
- item: Act 1 — Gale
  to: Bow of Awareness; Ring of Protection + Ring of Mind-Shielding; Spidersilk Armour; Elixir of Vigilance (daily); The Spellsparkler main hand + Melf's First Staff off hand (from char 4); The Shadespell Circlet; Boots of Stormy Clamour; Gloves of Belligerent Skies; Pearl of Power Amulet
...
- item: Act 2 — Gale
  to: Hat of Fire Acuity; Callous Glow Ring + Coruscation Ring (damage) or Ring of Mental Inhibition (control); Spineshudder Amulet; Boots of Stormy Clamour; Gloves of Belligerent Skies; Thunderskin Cloak
...
- item: Act 3 — Gale
  to: Markoheshkir main hand + Rhapsody off hand (Staff of Spellpower swap); Hat of Fire Acuity; Armour of Landfall; Spellmight Gloves; Cloak of the Weave; Spineshudder Amulet; Callous Glow + Coruscation/Mental Inhibition; Evasive Shoes; Hellrider Longbow
  why: 'Attune Markoheshkir to FLAME OF WRATH. Armour of Landfall''s Constitution-save ADVANTAGE is the load-bearing piece: it replaces the Halfling Luck and War Caster this build cannot have, and it is what makes Markoheshkir''s unavoidable Heat self-damage safe while concentrating on Twinned Haste. ⚠ Do not attune Flame of Wrath before Landfall is equipped. ⚠ Boots of Persistence and Vital Conduit Boots BOTH require Medium Armour proficiency, which he never gets — Evasive Shoes are the best legal option once Helldusk Boots go to Charles.'
- item: Act 1 — Bonbon
  to: Titanstring Bow + Club of Hill Giant Strength + Knife of the Undermountain King + Bloodlust; Gloves of Dexterity; The Protecty Sparkswall → Adamantine Splint Armour; Diadem of Arcane Synergy; Caustic Band + The Whispering Promise; Broodmother's Revenge; Boots of Speed
  why: 'Light Club and Knife share the melee set without a feat — Club gives STR 19, and the Knife''s crit-threshold reduction is GLOBAL, so it improves Titanstring and her spell attacks too. Bloodlust buys an extra Action after a kill; Hill Giant elixir for a boss with no adds. Protecty raises control DC early, then the first Mithral ore turns into Adamantine Splint for AC 18 and crit immunity. ⚠ No Adamantine Shield: the second ore goes to Charles''s Scale Mail, and the Splint already gives her crit immunity outright.'
- item: Acts 2–3 — Bonbon
  to: 'Act 2: Helmet of Arcane Acuity; Ne''er Misser + Hellfire Hand Crossbow; Spellcrux Amulet; Boots of Brilliance; Cloak of Cunning Brume. Act 3: Band of the Mystic Scoundrel; Armour of Agility; Wavemother''s Cloak; Boots of Persistence'
  why: 'The Act 2 pivot is the whole build: the Helmet turns weapon hits into spell save DC, so she drops Titanstring for dual hand crossbows because three or four small hits reach the +10 Acuity cap far faster than one big shot. The Helmet never comes off again, which is why Birthright is not worn — +2 Charisma is +1 DC against Acuity''s +10.'
- item: Risky Ring
  to: Charles
  why: 'Act 2 permanent attack advantage and crit-fishing. ⚠ The cost is real — disadvantage on every save, on the character holding concentration. Aura of Protection offsets part of it, the Cloak of Protection adds +1, and in Act 3 the Amulet of Greater Health cancels it outright on Constitution saves.'
...
- item: Hellrider's Longbow
  ...
  to: Gale
  why: 'Settled by the item itself: it is TWO-HANDED, so Bonbon cannot hold it beside the dual hand crossbows that are her entire Arcane Acuity engine. Gale''s ranged slot is idle all game, so he carries it as a pure stat stick — +3 Initiative on top of the standing Elixir of Vigilance, without spending the feat he does not have for Alert.'
- item: Amulet of Greater Health
  to: Charles
  why: 'Act 3 CON 23 plus advantage on Constitution saves. It goes to Charles because only he has a save DISADVANTAGE for the advantage to cancel — the Risky Ring. Gale already has CON-save advantage from Armour of Landfall and Bonbon from War Caster, so on them the headline effect is redundant; Bonbon keeps the Spellcrux Amulet instead.'
progression:
- act: 1
