...
sub: Turn ALL FOUR into partial-illithids — COMMUNE, never eat. Split PRE/POST Astral-Touched, because transforming refunds the inner-ring tadpoles.
intro: 'Two rules. (1) COMMUNE with the Emperor''s Astral-Touched Tadpole — communing leaves it intact for the next member, eating consumes it and only one character transforms. All four commune → all four get Fly + the five inner powers free. (2) Transforming REFUNDS tadpoles spent on those five inner powers, but NOT the ten middle-ring ones — hence PRE (Acts 1–2, buy only inner powers that help now) and POST (Act 3, refunds fund the elite ring). Vulnerability NEVER stacks: Perilous Stakes adds nothing to Stone psychic or Wet lightning/cold, but shines on radiant smites and Asterion''s bludgeoning/force.'
mechanics:
- k: Transform EVERYONE — commune, never eat
  v: 'Act 3 start, the Emperor hands it over: choose COMMUNE ("open your mind"), not Eat. Communing transforms you AND leaves the tadpole for the next member; eating destroys it. All four → Fly + Concentrated Blast + Favourable Beginnings + Force Tunnel + Psionic Overload + Transfuse Health, free.'
...
- k: Eligibility
  v: 'Only infected characters can use the Astral-Touched Tadpole. Withers HIRELINGS are not eligible — this works for Bonbon only as Alondra''s custom PC (confirm in-game). Halsin/Jaheira never qualify. Companions (Asterion, Gale) may need an approval nudge; PCs just choose.'
- k: Perilous Stakes = the damage multiplier
  v: 'MIDDLE ring (prereq Transfuse Health, refunded → net 1 tadpole; online Acts 1–2). INT save, and non-Honour it targets ENEMIES. Vulnerable to all damage for 3 turns — but vulnerability does not stack, so nothing for Stone psychic or Wet lightning/cold. It doubles the unmatched types: radiant smites, bludgeoning, force. The target heals 2d8 when IT attacks, so land it with Bonbon''s ~27 DC on a Held/Stunned boss.'
- k: Resonance Stone — psychic-double AND mental-save disadvantage
  v: 'Steeped in Bliss (9m) = Vulnerable to Psychic + DISADVANTAGE on INT/WIS/CHA saves. Asterion carries it to double Manifestation of Mind and Psionic Overload. Black Hole''s pull needs no save; its secondary INT Slow save is rolled at disadvantage inside the aura against his DC 17. Bonbon''s Acuity DC does not depend on it, and Perilous Stakes cannot re-double the psychic. ⚠ Undead and constructs are IMMUNE, and the Stone is bugged to sometimes stop working after Act 2 — Black Hole still pulls without it.'
- k: Watch-outs
  v: 'Psychic is widely resisted or immune late (undead, mind flayers, several Act 3 foes) — switch Asterion''s Manifestation to Soul (radiant) or Body (necrotic). Cull the Weak is good mob cleanup, but its kills do NOT trigger Deathstalker invisibility or Bloodlust — toggle it off when an on-kill proc matters. Freecast disables if you equip/unequip a RANGED weapon (Bonbon''s crossbows). Middle-ring spends never return, so prioritise Bonbon''s Perilous Stakes, Asterion''s Black Hole path, Charles''s Luck, and each caster''s Freecast path.'
- k: Fun / niche combos
  v: 'Repulsor (2d6 force + 6m knockback, short rest) + Displace (+1d8 psychic on fall damage you cause) off a ledge = chasm instakills that bypass HP — cheap, and everyone has Fly to set it up. Black Hole recasts 5 MORE times, so keep yanking a pack into one kill-zone. Displacer Beast Shape is an 85-HP panic tank that keeps your mental scores — the button for squishy Gale. Psionic Dominance is a free 1/long-rest counterspell-lite (spells targeting you of level ≤ your proficiency bonus).'
- k: Parasite economy
  v: 'Roughly two dozen across the run — Act 1: Grove library, ×3 at the Zaith''isk, ×1 Grove raid, ×1 Nere; Act 2: Moonrise + the Colony; plus infected cultists you kill, Gifts from the Absolute, and the Mind Flayer Brain. Transformation itself costs no specimen. Inner-ring refunds fund Bonbon''s elite tree, but middle-ring spends never return — don''t duplicate expensive active powers without an action-economy reason.'
...
- step: 1
  ...
  why: After the Goblin Camp bridge cutscene, the Dream Guardian visits at the next long rest → Embrace Your Potential. Consume your first parasite; every one after that feeds the tree.
- step: 2
  act: Act 1 (Crèche)
  who: Bonbon
  power: Awakened (Zaith'isk)
  why: 'Sit in the Zaith''isk and pass INT 12 / WIS 15 / CON 18 (save-scum) → powers become bonus actions. ⚠ MISSABLE — do it before the Crèche locks, and keep Ghustil alive until you have used the machine.'
- step: 3
  act: Acts 1–2
  who: Charles + Asterion
  power: Psionic Overload (inner); Favourable Beginnings only where needed
  why: +1d4 psychic per attack, refunded on transform. PRE-CAST before combat — an in-combat Action costs Charles three attacks or Asterion two. Favourable Beginnings is only a Luck prereq; the shared-target bug gives its bonus to whoever attacks first.
- step: 4
  act: Acts 1–2
  who: Charles (+ Asterion optional)
  power: Luck of the Far Realms (middle)
  why: Once per long rest, turn a SUCCESSFUL hit into a crit. Charles gets the most from Divine Smite; Asterion only extra damage — it cannot make a missed Stunning Strike hit or change its CON save. Never on a Held target or an already-critical attack.
- step: 5
  act: Acts 1–2
  who: Bonbon
  power: Transfuse Health → Perilous Stakes (middle)
  why: The broad vulnerability setter, online early. Bonbon has the best INT DC; cast it on a Held/Stunned boss so it cannot heal-on-attack. Doubles radiant smites, bludgeoning and force — never Stone psychic or Wet lightning/cold.
- step: 6
  act: Act 2 → 3
  who: ALL FOUR — COMMUNE
  power: Astral-Touched Tadpole → partial ceremorphosis
  why: 'On the road to Baldur''s Gate the Emperor offers it. Everyone COMMUNES: Fly + the 5 inner powers free, inner-ring spends refunded, elite ring unlocked. Cosmetic cost — dark eyes and black veins on all four, irreversible until the epilogue, no story consequence.'
- step: 7
  act: Act 3
  who: Bonbon
  power: Perilous Stakes + Mind Blast + Freecast + Mind Sanctuary
  why: The high-DC Illithid controller. Weapon attacks build Acuity, then Awakened casts Stakes or Mind Blast as a Bonus Action. Band for Command/Hold turns, Stakes for boss vulnerability, Mind Blast when its 14m Stun cone beats both. Freecast adds another L6 spell; Mind Sanctuary is party-wide. Skip Illithid Expertise — his Bard picks already cover all three face skills.
- step: 8
  act: Act 3
  who: Charles
...
- name: Charles
  ...
  - power: Favourable Beginnings
    ...
    prereq: —
    when: PRE (Act 1)
    why: Luck prereq. Its attack bonus goes only to the first party member who attacks a shared target.
  - power: Psionic Overload
    tier: Inner (free/refunded)
    prereq: —
    when: PRE (Act 1–2)
    why: PRE-CAST before combat for +1d4 psychic per attack across every swing, doubled by the Stone. Never burn a three-attack Action on it.
...
- name: Asterion
  ...
  - power: Psionic Overload
    ...
    prereq: —
    when: PRE (Act 1–2)
    why: MARQUEE. Pre-cast before combat; +1d4 psychic on every unarmed hit, doubled by the Stone. Activating it in combat costs his two-attack Action.
  - power: Favourable Beginnings
    tier: Inner (free/refunded)
    prereq: —
    when: PRE (Act 1)
    why: Pre-transformation only if he usually attacks each target first, or to unlock optional Luck; the shared-target bug prevents duplicate bonuses.
  - power: Luck of the Far Realms
    tier: Middle (optional)
    prereq: Favourable Beginnings
    when: PRE (Act 1–2)
    why: Turns a successful hit into a crit. Cannot make a missed Stunning Strike hit and does not affect the CON save.
  - power: Displace
    tier: Middle
    prereq: Force Tunnel (auto on transform)
    when: POST (Act 3)
    why: Path node for Black Hole; the fall-damage rider is secondary.
  - power: Black Hole
    tier: Elite
    prereq: Displace
    when: POST (Act 3)
...
- name: Bonbon
  ...
  note: Weapon attacks build Acuity, then Awakened casts an Illithid power as a Bonus Action at the party's best DC. Perilous Stakes for unmatched damage types on a boss; Mind Blast when its 14m Stun cone beats Band-enabled Command/Hold. Asterion handles first-turn Black Hole so Bonbon keeps his Bonus Action free. ⚠ No ranged-weapon swap on a Freecast turn.
  powers:
  - power: Favourable Beginnings
    tier: Inner (free/refunded)
    prereq: —
    when: PRE (Act 1)
    why: Good for the first Persuasion/Deception check on a target; in combat only the first attacker gets the bonus.
  - power: Perilous Stakes
    tier: Middle
    prereq: Transfuse Health (refunded)
    when: PRE (Act 1–2)
    why: High-DC vulnerability for unmatched damage types. Cast on a Held/Stunned target so it cannot heal-on-attack; does not stack with Stone or Wet.
  - power: Mind Blast
    tier: Elite
  ...
  - power: Freecast
    ...
    prereq: Shield of Thralls
    when: POST (Act 3)
    why: Next spell is free → a no-slot 6th-level Command (6 targets), or a free Hold Monster / Perilous Stakes.
