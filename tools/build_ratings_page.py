...
reads the whole of `resources/tiers/item_tiers.json`, not just the party's gear:

    resources/tiers/slots/*.json  --(merge_slot_tiers.py)-->  resources/tiers/item_tiers.json
                                                              |
...
def main():
    ...
    lines = ["---",
             "# GENERATED by tools/build_ratings_page.py from resources/tiers/item_tiers.json.",
